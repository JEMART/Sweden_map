...
swedenMap<-function(x,mypalette="Reds",dir){
  ...
  g<-ggplot() +
    geom_polygon(data = final.plot, 
                 aes(x = long, y = lat, group = group, fill = NKI,label=County), 
  ...
  dir<-dir
  ggsave(g, file = paste(dir,"\\",y,".png",sep=""), width = 6, height = 4.5, type = "cairo-png",dpi=300)
